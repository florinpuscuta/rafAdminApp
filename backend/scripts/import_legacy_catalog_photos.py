"""Import poze catalog din uploads/sikadp/catalog/{luna}/*.jpg în gallery (type='catalog').

Analog import_legacy_magazine_photos dar cu type='catalog'.
"""
...
SRC = Path(sys.argv[1] if len(sys.argv) > 1 else "/tmp/pa_catalog")
