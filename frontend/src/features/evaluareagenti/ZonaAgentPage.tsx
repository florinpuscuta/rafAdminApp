...
const styles: Record<string, CSSProperties> = {
  wrap: { padding: "16px 8px", maxWidth: 1600 },
  ...
  lead: { color: "var(--muted)", fontSize: 12, margin: 0, maxWidth: 640, lineHeight: 1.5 },
  muted: { color: "var(--muted)", fontSize: 13, padding: "24px 0" },
  mutedSmall: { color: "var(--muted)", fontSize: 12, padding: "8px 4px" },
  ...
  td: { padding: "8px 8px", textAlign: "right", borderBottom: "1px solid var(--border)", fontVariantNumeric: "tabular-nums" },
  tdLeft: { padding: "8px 12px", textAlign: "left", borderBottom: "1px solid var(--border)", fontWeight: 600 },
  rowClick: { cursor: "pointer" },
  rowOpen: { background: "rgba(34,211,238,0.04)" },
  rowDirty: { background: "rgba(234,179,8,0.06)" },
  chev: { display: "inline-block", color: "var(--muted)", fontSize: 16, marginRight: 8, transition: "transform 120ms ease" },
  expandCell: { padding: "8px 12px 16px 32px", background: "rgba(0,0,0,0.15)", borderBottom: "1px solid var(--border)" },
  innerTable: { width: "100%", borderCollapse: "collapse", fontSize: 12, background: "var(--bg-panel)", border: "1px solid var(--border)", borderRadius: 6 },
  innerTh: { padding: "8px 8px", textAlign: "right", fontSize: 10, fontWeight: 600, color: "var(--muted)", borderBottom: "1px solid var(--border)", background: "var(--bg-sidebar)", textTransform: "uppercase", letterSpacing: "0.04em" },
  innerThLeft: { padding: "8px 10px", textAlign: "left", fontSize: 10, fontWeight: 600, color: "var(--muted)", borderBottom: "1px solid var(--border)", background: "var(--bg-sidebar)", textTransform: "uppercase", letterSpacing: "0.04em" },
  innerTd: { padding: "5px 8px", textAlign: "right", borderBottom: "1px solid var(--border)", fontVariantNumeric: "tabular-nums" },
  innerTdLeft: { padding: "5px 10px", textAlign: "left", borderBottom: "1px solid var(--border)" },
  innerTotal: { padding: "8px 10px", background: "var(--bg-sidebar)", fontWeight: 700, color: "var(--cyan)", borderTop: "1px solid var(--border)" },
  innerTotalNum: { padding: "8px 8px", background: "var(--bg-sidebar)", fontWeight: 700, color: "var(--cyan)", textAlign: "right", fontVariantNumeric: "tabular-nums", borderTop: "1px solid var(--border)" },
  inpNum: { width: 110, padding: "4px 6px", textAlign: "right", fontSize: 12, background: "var(--bg)", border: "1px solid var(--border)", color: "var(--text)", borderRadius: 4, fontVariantNumeric: "tabular-nums" },
  inpText: { width: "100%", minWidth: 140, padding: "4px 6px", fontSize: 12, background: "var(--bg)", border: "1px solid var(--border)", color: "var(--text)", borderRadius: 4 },
  saveBtn: { padding: "5px 12px", fontSize: 11, fontWeight: 600, background: "var(--cyan)", color: "#000", border: "none", borderRadius: 4, minWidth: 80 },
