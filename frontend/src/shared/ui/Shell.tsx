...
const FULL_CONSOLIDATED_PATHS = [
  ...
  "/unmapped/products",
  "/analiza/comenzi",
  // Cat 2 batch A — marketing + product analytics
  "/marketing/concurenta",
  "/marketing/catalog",
  "/marketing/facing",
  "/marketing/dash-face",
  "/marketing/facing-config",
  "/marketing/panouri",
  "/marketing/sika",
  "/eps",
  "/mortar",
  "/privatelabel",
  // Cat 2 batch B — activity / reports / analytics
  "/bonusari",
  "/taskuri",
  "/parcurs",
  "/activitate",
  ...
  "/forecast",
  "/grupe-arbore",
  "/grupe-arbore-clienti",
  "/grupe/",
  "/evaluare/facturi-bonus",
];
